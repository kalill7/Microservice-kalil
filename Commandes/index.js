...
const isAuthenticated = require('./Authentification');
...
async function connectDB() {
    ...
    while (retries) {
        try {
            ...
            console.log('✅ Commandes_Service connecté à MongoDB');
            break;
        } catch (error) {
            console.error('❌ Erreur connexion MongoDB:', error);
            retries--;
            console.log(`Nouvelle tentative dans 5s... (${retries} restantes)`);
